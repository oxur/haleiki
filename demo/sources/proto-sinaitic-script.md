...
original_source:
  ...
  fetched_at: 2026-05-03T22:20:25Z
  revision_id: W/"1347756208/b6c0f359-4739-11f1-b6f0-758474aa04e4/view/html
...
![Ba`alat](../media/proto-sinaitic-script/Ba%60alat.jpg)
...
Ten years later, in 1916, [Alan Gardiner](https://en.wikipedia.org/wiki/Alan_Gardiner "Alan Gardiner"), one of the premier [Egyptologists](https://en.wikipedia.org/wiki/Egyptology "Egyptology") of the early and mid-20th century, published his own interpretation of Petrie's findings, arguing that the [glyphs](https://en.wikipedia.org/wiki/Glyph "Glyph") appeared to be early versions of the signs used for later [Semitic languages](https://en.wikipedia.org/wiki/Semitic_languages "Semitic languages") such as [Phoenician](https://en.wikipedia.org/wiki/Phoenician_language "Phoenician language"), and was able to assign sound values and reconstructed names to some of the letters by assuming they represented what would later become the common Semitic [abjad](https://en.wikipedia.org/wiki/Abjad "Abjad"). One example was the character ![Proto-semiticB-01](../media/proto-sinaitic-script/Proto-semiticB-01.svg), to which Gardiner assigned the [⟨b⟩](https://en.wikipedia.org/wiki/Voiced_bilabial_stop "Voiced bilabial stop") sound, on the grounds that it derived from the Egyptian glyph for 'house' ![EgyptianB-01](../media/proto-sinaitic-script/EgyptianB-01.svg), and was very similar to the Phoenician letter ![Phoenician beth](../media/proto-sinaitic-script/Phoenician_beth.svg) _bet_, whose name derives from the Semitic word for “house”, _bayt_. Using his hypothesis, Gardiner was able to affirm Petrie's hypothesis that the mystery inscriptions were of a religious nature, as his model allowed an often recurring word to be reconstructed as _[l](https://en.wikipedia.org/wiki/Lamedh "Lamedh")[bʿl](https://en.wikipedia.org/wiki/Baal "Baal")[t](https://en.wikipedia.org/wiki/Taw "Taw")_, meaning "to Ba'alat" or more accurately, "to (the) Lady" – that is, the "lady" [Hathor](https://en.wikipedia.org/wiki/Hathor "Hathor"). Likewise, this allowed another recurring word _[m](https://en.wikipedia.org/wiki/Mem "Mem")[ʿ](https://en.wikipedia.org/wiki/Aleph "Aleph")[h](https://en.wikipedia.org/wiki/He_\(letter\) "He (letter)")bʿlt_ to be translated as "Beloved of (the) Lady", a reading which became very acceptable after the [lemma](https://en.wikipedia.org/wiki/Lemma_\(morphology\) "Lemma (morphology)") was found carved underneath a hieroglyphic inscription which read "Beloved of Hathor, Lady of Turquoise". Gardiner's hypothesis allowed researchers to connect the letters of the inscriptions to modern Semitic alphabets, and resulted in the inscriptions becoming much more readable, leading to the immediate acceptance of his hypothesis.
...
![Traces of the 16 and 12 characters of the two Wadi el-Hol inscriptions](../media/proto-sinaitic-script/Wadi_el-Hol_inscriptions_drawing.jpg)Traces of the 16 and 12 characters of the two Wadi el-Hol inscriptions
...
![A28](../media/proto-sinaitic-script/hiero_A28.png "A28")

![A17](../media/proto-sinaitic-script/hiero_A17.png "A17")

![A32](../media/proto-sinaitic-script/hiero_A32.png "A32")
...
![F1](../media/proto-sinaitic-script/hiero_F1.png "F1")

[𓃾](https://en.wikipedia.org/wiki/List_of_Egyptian_hieroglyphs#F1 "List of Egyptian hieroglyphs")

![Aleph](../media/proto-sinaitic-script/Proto-semiticA-01.svg)

![Wadi el-hol-A02](../media/proto-sinaitic-script/Wadi_el-hol-A02.svg)
...
![𐤀](../media/proto-sinaitic-script/Phoenician_aleph.svg)𐤀

![O1](../media/proto-sinaitic-script/hiero_O1.png "O1")

[𓉐](https://en.wikipedia.org/wiki/List_of_Egyptian_hieroglyphs#O1 "List of Egyptian hieroglyphs")

![Serabit-El-Khadim-B346](../media/proto-sinaitic-script/Serabit-El-Khadim-B346.svg)
(346)
...
![𐤁](../media/proto-sinaitic-script/Phoenician_beth.svg)𐤁

![O4](../media/proto-sinaitic-script/hiero_O4.png "O4")

[𓉔](https://en.wikipedia.org/wiki/List_of_Egyptian_hieroglyphs#O4 "List of Egyptian hieroglyphs")

—N/a

![Wadi el-hol-B](../media/proto-sinaitic-script/Wadi_el-hol-B.svg)

—N/a

![T14](../media/proto-sinaitic-script/hiero_T14.png "T14")

[𓌙](https://en.wikipedia.org/wiki/List_of_Egyptian_hieroglyphs#T14 "List of Egyptian hieroglyphs")

![Gimel](../media/proto-sinaitic-script/Proto-semiticG-01.svg)
...
![𐤂](../media/proto-sinaitic-script/Phoenician_gimel.svg)𐤂

![O31](../media/proto-sinaitic-script/hiero_O31.png "O31")

[𓉿](https://en.wikipedia.org/wiki/List_of_Egyptian_hieroglyphs#O31 "List of Egyptian hieroglyphs")

![Serabit-El-Khadim-D367](../media/proto-sinaitic-script/Serabit-El-Khadim-D367.svg)
(367)
...
![𐤃](../media/proto-sinaitic-script/Phoenician_daleth.svg)𐤃

![K5](../media/proto-sinaitic-script/hiero_K5.png "K5")

[𓆟](https://en.wikipedia.org/wiki/List_of_Egyptian_hieroglyphs#K5 "List of Egyptian hieroglyphs") or

![K7](../media/proto-sinaitic-script/hiero_K7.png "K7")

[𓆡](https://en.wikipedia.org/wiki/List_of_Egyptian_hieroglyphs#K7 "List of Egyptian hieroglyphs")

![Serabit-El-Khadim-D346](../media/proto-sinaitic-script/Serabit-El-Khadim-D346.svg)
(346)
...
![Serabit-El-Khadim-H354](../media/proto-sinaitic-script/Serabit-El-Khadim-H354.svg)
(354)
...
![𐤄](../media/proto-sinaitic-script/Phoenician_he.svg)𐤄

![A2](../media/proto-sinaitic-script/hiero_A2.png "A2")

[𓀁](https://en.wikipedia.org/wiki/List_of_Egyptian_hieroglyphs#A2 "List of Egyptian hieroglyphs")

—N/a

![Wadi el-hol-H01](../media/proto-sinaitic-script/Wadi_el-hol-H01.svg)

—N/a

![T3](../media/proto-sinaitic-script/hiero_T3.png "T3")

[𓌉](https://en.wikipedia.org/wiki/List_of_Egyptian_hieroglyphs#T3 "List of Egyptian hieroglyphs")

![Waw](../media/proto-sinaitic-script/Proto-semiticW-01.svg)

![Wadi el-hol-W](../media/proto-sinaitic-script/Wadi_el-hol-W.svg)?
...
![𐤅](../media/proto-sinaitic-script/Phoenician_waw.svg)𐤅

![Z4](../media/proto-sinaitic-script/hiero_Z4.png "Z4")

[𓏭](https://en.wikipedia.org/wiki/List_of_Egyptian_hieroglyphs#Z4 "List of Egyptian hieroglyphs") or

![D13](../media/proto-sinaitic-script/hiero_D13.png "D13")

[𓂃](https://en.wikipedia.org/wiki/List_of_Egyptian_hieroglyphs#D13 "List of Egyptian hieroglyphs")

![Zayin](../media/proto-sinaitic-script/Proto-semiticZ-01.svg)

—N/a

![Timna-Ḏ](../media/proto-sinaitic-script/Timna-%E1%B8%8E.svg)

/z/ or /ð/

[zayn](https://en.wikipedia.org/wiki/Zayin "Zayin") "weapon" or [ḏayp](https://en.wikipedia.org/wiki/Zayin "Zayin") "eyebrow"

![𐤆](../media/proto-sinaitic-script/Phoenician_zayin.svg)𐤆

![O6](../media/proto-sinaitic-script/hiero_O6.png "O6")
...
![Serabit-El-Khadim-Ḥ362](../media/proto-sinaitic-script/Serabit-El-Khadim-%E1%B8%A4362.svg)
(362)
...
![𐤇](../media/proto-sinaitic-script/Phoenician_heth.svg)𐤇

![V28](../media/proto-sinaitic-script/hiero_V28.png "V28")

[𓎛](https://en.wikipedia.org/wiki/List_of_Egyptian_hieroglyphs#V28 "List of Egyptian hieroglyphs")

![𓎛](../media/proto-sinaitic-script/Inscription_349_Proto-Sinaitic_Heth.svg)

(349)

![Wadi el-hol-H̱](../media/proto-sinaitic-script/Wadi_el-hol-H%CC%B1.svg)

![Timna-X](../media/proto-sinaitic-script/Timna-X.svg)

/x/

[ḫayt](https://en.wikipedia.org/wiki/Heth "Heth") "thread"

![F35](../media/proto-sinaitic-script/hiero_F35.png "F35")

[𓄤](https://en.wikipedia.org/wiki/List_of_Egyptian_hieroglyphs#F35 "List of Egyptian hieroglyphs")

![Proto-semiticṬ-01](../media/proto-sinaitic-script/Proto-semitic%E1%B9%AC-01.svg)
...
![𐤈](../media/proto-sinaitic-script/Phoenician_teth.svg)𐤈

![D36](../media/proto-sinaitic-script/hiero_D36.png "D36")

[𓂝](https://en.wikipedia.org/wiki/List_of_Egyptian_hieroglyphs#D36 "List of Egyptian hieroglyphs")

![Yad](../media/proto-sinaitic-script/Proto-semiticI-02.svg) ![Yad](../media/proto-sinaitic-script/Proto-semiticI-01.svg)

![Wadi el-hol-J](../media/proto-sinaitic-script/Wadi_el-hol-J.svg)
...
![𐤉](../media/proto-sinaitic-script/Phoenician_yodh.svg)𐤉

![D46](../media/proto-sinaitic-script/hiero_D46.png "D46")

[𓂧](https://en.wikipedia.org/wiki/List_of_Egyptian_hieroglyphs#D46 "List of Egyptian hieroglyphs")

![Serabit-El-Khadim-K363](../media/proto-sinaitic-script/Serabit-El-Khadim-K363.svg)
(363)

—N/a

![Timna-K](../media/proto-sinaitic-script/Timna-K.svg)

/k/

[kap](https://en.wikipedia.org/wiki/Kaph "Kaph") "palm"

![𐤊](../media/proto-sinaitic-script/Phoenician_kaph.svg)𐤊

![V1](../media/proto-sinaitic-script/hiero_V1.png "V1")

[𓍢](https://en.wikipedia.org/wiki/List_of_Egyptian_hieroglyphs#V1 "List of Egyptian hieroglyphs") or

![S39](../media/proto-sinaitic-script/hiero_S39.png "S39")

[𓋿](https://en.wikipedia.org/wiki/List_of_Egyptian_hieroglyphs#S39 "List of Egyptian hieroglyphs")

![Serabit-El-Khadim-L358](../media/proto-sinaitic-script/Serabit-El-Khadim-L358.svg)
(358)
![Serabit-El-Khadim-L348](../media/proto-sinaitic-script/Serabit-El-Khadim-L348.svg)
(348)

![Wadi el-hol-L](../media/proto-sinaitic-script/Wadi_el-hol-L.svg)?

![Timna-L](../media/proto-sinaitic-script/Timna-L.svg)

/l/

[lamd](https://en.wikipedia.org/wiki/Lamedh "Lamedh") "goad"

![𐤋](../media/proto-sinaitic-script/Phoenician_lamedh.svg)𐤋

![N35](../media/proto-sinaitic-script/hiero_N35.png "N35")

[𓈖](https://en.wikipedia.org/wiki/List_of_Egyptian_hieroglyphs#N35 "List of Egyptian hieroglyphs")

![Serabit-El-Khadim-M354](../media/proto-sinaitic-script/Serabit-El-Khadim-M354.svg)
(354)

![Wadi el-hol-M02](../media/proto-sinaitic-script/Wadi_el-hol-M02.svg)

![Timna-M](../media/proto-sinaitic-script/Timna-M.svg)

/m/

[maym](https://en.wikipedia.org/wiki/Mem "Mem") "water"

![𐤌](../media/proto-sinaitic-script/Phoenician_mem.svg)𐤌

![I10](../media/proto-sinaitic-script/hiero_I10.png "I10")

[𓆓](https://en.wikipedia.org/wiki/List_of_Egyptian_hieroglyphs#I10 "List of Egyptian hieroglyphs")

![Nun](../media/proto-sinaitic-script/Proto-semiticN-01.svg)

![Wadi el-hol-N01](../media/proto-sinaitic-script/Wadi_el-hol-N01.svg)
...
![𐤍](../media/proto-sinaitic-script/Phoenician_nun.svg)𐤍

![R11](../media/proto-sinaitic-script/hiero_R11.png "R11")
...
![𐤎](../media/proto-sinaitic-script/Phoenician_samekh.svg)𐤎

![D4](../media/proto-sinaitic-script/hiero_D4.png "D4")

[𓁹](https://en.wikipedia.org/wiki/List_of_Egyptian_hieroglyphs#D4 "List of Egyptian hieroglyphs")

![Ayin](../media/proto-sinaitic-script/Proto-semiticO-01.svg)

![Wadi el-hol-O](../media/proto-sinaitic-script/Wadi_el-hol-O.svg)

![Timna-O](../media/proto-sinaitic-script/Timna-O.svg)

/ʕ/

[ʿayn](https://en.wikipedia.org/wiki/ʿen "ʿen") "eye"

![𐤏](../media/proto-sinaitic-script/Phoenician_ayin.svg)𐤏

![D21](../media/proto-sinaitic-script/hiero_D21.png "D21")

[𓂋](https://en.wikipedia.org/wiki/List_of_Egyptian_hieroglyphs#D21 "List of Egyptian hieroglyphs")

![Serabit-El-Khadim-O346](../media/proto-sinaitic-script/Serabit-El-Khadim-O346.svg)
(346)
...
![𐤑](../media/proto-sinaitic-script/Phoenician_sade.svg)𐤑

![Abydos-Bold-hieroglyph-E36](../media/proto-sinaitic-script/Abydos-Bold-hieroglyph-E36.png)

𓫪

![Qoph](../media/proto-sinaitic-script/Proto-semiticQ-01.svg)
...
![𐤒](../media/proto-sinaitic-script/Phoenician_qoph.svg)𐤒

![V24](../media/proto-sinaitic-script/hiero_V24.png "V24")
...
![D1](../media/proto-sinaitic-script/hiero_D1.png "D1")

[𓁶](https://en.wikipedia.org/wiki/List_of_Egyptian_hieroglyphs#D1 "List of Egyptian hieroglyphs") or

![D19](../media/proto-sinaitic-script/hiero_D19.png "D19")

[𓂉](https://en.wikipedia.org/wiki/List_of_Egyptian_hieroglyphs#D19 "List of Egyptian hieroglyphs")

![Serabit-El-Khadim-R352](../media/proto-sinaitic-script/Serabit-El-Khadim-R352.svg)
(352)

![Wadi el-hol-R011](../media/proto-sinaitic-script/Wadi_el-hol-R011.svg)

![Timna-R](../media/proto-sinaitic-script/Timna-R.svg)

/r/

[raʾš](https://en.wikipedia.org/wiki/Resh "Resh") "head"

![𐤓](../media/proto-sinaitic-script/Phoenician_res.svg)𐤓

![Abydos-Bold-hieroglyph-N6B](../media/proto-sinaitic-script/Abydos-Bold-hieroglyph-N6B.png)𓻔

—N/a

![Wadi el-hol-Š](../media/proto-sinaitic-script/Wadi_el-hol-%C5%A0.svg)

![Timna-Š](../media/proto-sinaitic-script/Timna-%C5%A0.svg)

/ʃ/

[šamš](https://en.wikipedia.org/wiki/Shin_\(letter\) "Shin (letter)") "sun"

![𐤔](../media/proto-sinaitic-script/Phoenician_sin.svg)𐤔

![Proto-semiticŠ-02](../media/proto-sinaitic-script/Proto-semitic%C5%A0-02.svg)
(357)
...
![T10](../media/proto-sinaitic-script/hiero_T10.png "T10")

[𓌔](https://en.wikipedia.org/wiki/List_of_Egyptian_hieroglyphs#T10 "List of Egyptian hieroglyphs") or

![Aa32](../media/proto-sinaitic-script/hiero_Aa32.png "Aa32")

[𓐮](https://en.wikipedia.org/wiki/List_of_Egyptian_hieroglyphs#Aa32 "List of Egyptian hieroglyphs")?

![Serabit-El-Khadim-Š357](../media/proto-sinaitic-script/Serabit-El-Khadim-%C5%A0357.svg)
(357)

![Serabit-El-Khadim-Ṯ348](../media/proto-sinaitic-script/Serabit-El-Khadim-%E1%B9%AE348.svg)
(348)

![Wadi el-hol-Ṯ](../media/proto-sinaitic-script/Wadi_el-hol-%E1%B9%AE.svg)
...
![Z9](../media/proto-sinaitic-script/hiero_Z9.png "Z9")

[𓏴](https://en.wikipedia.org/wiki/List_of_Egyptian_hieroglyphs#Z9 "List of Egyptian hieroglyphs")?

![Tof](../media/proto-sinaitic-script/Proto-semiticT-01.svg)

![Wadi el-hol-T](../media/proto-sinaitic-script/Wadi_el-hol-T.svg)
...
![𐤕](../media/proto-sinaitic-script/Phoenician_taw.svg)𐤕
