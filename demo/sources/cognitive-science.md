...
![A well known example of a phrase structure tree. This is one way to represent human language, showing how its components are organized hierarchically.](../media/cognitive-science/Cgisf-tgg.svg)A [well known example](https://en.wikipedia.org/wiki/Colorless_green_ideas_sleep_furiously "Colorless green ideas sleep furiously") of a [phrase structure tree](https://en.wikipedia.org/wiki/Phrase_structure_rules "Phrase structure rules"). This is one way to represent human language, showing how its components are organized hierarchically.
...
![The Necker cube, an example of an optical illusion](../media/cognitive-science/Necker_cube.svg)[The Necker cube](https://en.wikipedia.org/wiki/The_Necker_cube "The Necker cube"), an example of an optical illusion![An optical illusion. The square A is the same shade of gray as square B. See checker shadow illusion.](../media/cognitive-science/Checker_shadow_illusion.svg)An optical illusion. The square A is the same shade of gray as square B. See [checker shadow illusion](https://en.wikipedia.org/wiki/Checker_shadow_illusion "Checker shadow illusion").
...
![17th-century representation of consciousness by Robert Fludd, an English Paracelsian physician](../media/cognitive-science/RobertFuddBewusstsein17Jh.png)17th-century representation of consciousness by [Robert Fludd](https://en.wikipedia.org/wiki/Robert_Fludd "Robert Fludd"), an English [Paracelsian](https://en.wikipedia.org/wiki/Paracelsianism "Paracelsianism") physician
...
![Image of the human head with the brain. The arrow indicates the position of the hypothalamus.](../media/cognitive-science/Hypothalamus.jpg)Image of the human head with the brain. The arrow indicates the position of the [hypothalamus](https://en.wikipedia.org/wiki/Hypothalamus "Hypothalamus").
...
![An artificial neural network with two layers](../media/cognitive-science/Multi-Layer_Neural_Network-Vector.svg)An [artificial neural network](https://en.wikipedia.org/wiki/Artificial_neural_network "Artificial neural network") with two layers
