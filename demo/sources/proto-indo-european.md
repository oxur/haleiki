...
original_source:
  ...
  revision_id: W/"1352304105/e0c5e20c-4738-11f1-8f9f-1f898662e1e2/view/html
...
![Early Indo-European migrations from the Pontic steppes and across Central Asia according to the widely held Kurgan hypothesis](../media/proto-indo-european/Indo-European_migrations.jpg)Early [Indo-European migrations](https://en.wikipedia.org/wiki/Indo-European_migrations "Indo-European migrations") from the [Pontic steppes](https://en.wikipedia.org/wiki/Pontic_steppes "Pontic steppes") and across Central Asia according to the widely held Kurgan hypothesis
...
![Classification of Indo-European languages. Red: Extinct languages. White: categories or unattested proto-languages. Left half: centum languages; right half: satem languages](../media/proto-indo-european/IndoEuropeanTree.svg)Classification of Indo-European languages. Red: Extinct languages. White: categories or unattested proto-languages. Left half: [centum](https://en.wikipedia.org/wiki/Centum "Centum") languages; right half: [satem](https://en.wikipedia.org/wiki/Satem "Satem") languages
